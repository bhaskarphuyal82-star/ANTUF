      ...
      {content.map((content, index) => (
        <Box
          ...
          sx={{
            ...
            boxShadow: "0px 1px 4px rgba(216, 0, 0, 0.2)",
          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={6}>
              ...
              >
                ...
                >
                  <img
                    src={content?.featureImage || "https://placehold.co/600x400"}
                    alt={content?.imageAlt || content?.title || "Article image"}
                    style={{
                      width: "100%",
                      height: "100%",
                      objectFit: "cover",
              ...
              >
                ...
                >
                   Category: {content?.category?.name || "No category"}
                </Typography>
              </Box>
              </Box>
            </Grid>

            <Grid size={{ xs: 4, md: 4 }} offset={{ md: "auto" }}>
              {hoverIndex === index ? (
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  {/* <Tooltip title="Manage Post">
                    <IconButton
                      size="large"
                      sx={{ color: "aqua" }}
                      onClick={() =>
                        router.push(
                          `/dashboard/admin/edit/Article/curriculumcourseeditor?search=${content?._id}`
                        )
                      }
                    >
                  ...
                  <Tooltip title="Source">
                    <IconButton
                      ...
                      onClick={() =>
                        router.push(
                          `/dashboard/admin/create/post/articleeditorcontent?search=${content._id}`
                        )
                      }
                    >
